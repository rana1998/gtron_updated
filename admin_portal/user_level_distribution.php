...
$db = getDB();
$response = AdminHelper::getNewRegisteredUserDetails($db);
?>  
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <div class="d-inline">
                            <h4>User level distribution table</h4>
                            <span>Summary of all User level</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item"><a href="#!">User level info</a> </li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <table id="user-info-table" class="table table-striped table-bordered nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($response as $data) { ?>
                                            ...
                                            <td><?php echo $data['user_referral_id']; ?></td>
                                            <td><?php echo $data['referrer_user_id']; ?></td>
                                            <td><?php echo $data['reffered_user_count']; ?></td>
                                            <td><?php echo $data['gtron']; ?></td>
                                            <td><?php echo $data['registration_date']; ?></td>
                                            <td>
                                                <a href="edit_user_level_distribution.php?id=<?php echo $data['id'];  ?>" class="btn btn-outline-info btn-sm"> <i class="feather icon-edit"></i> Edit level</a>
                                            </td>
                                            </tr>
                                        <?php }
                                        ?>
