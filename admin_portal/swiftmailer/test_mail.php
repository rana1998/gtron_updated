...
$transport = Swift_SmtpTransport::newInstance('sosolutions.com.pk', 25);

// Create the Mailer using your created Transport
$mailer = Swift_Mailer::newInstance($transport);

// Create a message
$message = Swift_Message::newInstance('New Enquiry')
  ->setFrom(array('info@sosolutions.com.pk' => 'Historial'))
...
<head>
  ...
  <title>Reset Your Snapdove Password</title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 background-color: #3C80C3; height: 100%; margin: 0; padding: 0; width: 100%">
  <center>
 ...
 padding-bottom: 9px; padding-left: 18px;" valign="top">
                                <a href="http://www.snapdove.com" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #2a2a2a;
 font-weight: normal; text-decoration: none" target="_blank" title="Snapdove is the
 best way to organize, share and use all your visual assets in one place -
 all on your desktop.">
                                  <img align="none" alt="Snapdove is the best way" src="http://snapdove.com/images/logo.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                <a class="" href="http://www.snapdove.com" style="mso-line-height-rule:
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
                                    <img align="center" alt="Forgot your password?" class="mcnImage" src="http://snapdove.com/images/logo.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none; width: 70px;
 ...
 padding-bottom: 9px; padding-left: 18px;" valign="top">
                                ...
                                <h1 class="null" style="color: #2a2a2a; font-size: 32px; font-style: normal; font-weight: bold; line-height:
 125%; letter-spacing: 2px; text-align: center; display: block; margin: 0;
 padding: 0"><span style="text-transform:uppercase">Successfully</span></h1>


                                <h2 class="null" style="color: #2a2a2a; font-size: 24px; font-style: normal; font-weight: bold; line-height:
 125%; letter-spacing: 1px; text-align: center; display: block; margin: 0;
 padding: 0"><span style="text-transform:uppercase">Place Order</span></h2>
 ...
 color: #2a2a2a; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;" valign="top">Your order has been rejected on by snapdove
 <br><br>
 <b>Reason:</b>
 <br>
 '.$reason.'
...
" text-align="left" width="100%">
 ...
 text-align: left; text-align: left; font-size: 14px; ">Snapdove is a visual asset manager made for collaboration. Build a central library for your teams visual assets. Empower creation and ensure consistency from your desktop.
                              </p>
                              <div style="padding-bottom: 18px;">
                                <a href="http://www.snapdove.com" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%; color: #f57153; font-weight: normal; text-decoration: none;
 font-size: 14px; color:#F57153; text-decoration:none;" target="_blank" title="Learn more about Snapdove">Learn More ❯</a>
                              </div>
                            </td>
                          </tr>
                        </table>
 ...
 100%; -webkit-text-size-adjust: 100%; ">
                          <tbody>
                            <tr>
                              <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%">
                                <a href="http://twitter.com/@Snapdove_app" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%; color: #f57153; font-weight: normal; text-decoration: none" target="_blank">
                                  <img alt="twitter" height="32" src="http://snapdove.com/images/twitter-ic-32x32-email@2x.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none; text-decoration:
 none" width="32" />
                                </a>
                              </td>
                              <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%">
                                <a href="http://www.instagram.com/Snapdove_app/" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%; color: #f57153; font-weight: normal; text-decoration:
 none" target="_blank">
                                  <img alt="Instagram" height="32" src="http://snapdove.com/images/instagram-ic-32x32-email@2x.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
 text-decoration: none" width="32" />
                                </a>
                              </td>
                              <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%">
                                <a href="http://medium.com/@Snapdove_app" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%; color: #f57153; font-weight: normal; text-decoration: none" target="_blank">
                                  <img alt="medium" height="32" src="http://snapdove.com/images/medium-ic-32x32-email@2x.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none; text-decoration: none" width="32" />
                                </a>
                              </td>
                              <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%">
                                <a href="http://www.facebook.com/Snapdoveapp/" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%; color: #f57153; font-weight: normal; text-decoration: none" target="_blank">
                                  <img alt="facebook" height="32" src="http://snapdove.com/images/facebook-ic-32x32-email@2x.png" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
 text-decoration: none" width="32" />
                                </a>
                              </td>
                            </tr>
