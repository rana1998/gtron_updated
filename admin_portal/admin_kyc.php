...
?>  
                        ...
                        ?>
                                                            <tr>
																...
																<td>
                                                                    <?php if($data['status'] == 'Pending' || $data['status'] == 'Reject') {?>
																	<a href="admin_kyc.php?approved_btn=<?php echo $data['id']; ?>&action=Approved"  class="btn btn-success btn-sm">Enable</a>
                                                                    <?php } elseif ($data['status'] == 'Approved') { ?>                                                                    
																	<a href="JavaScript:Void(0)"  class="btn btn-danger btn-sm btn-reject" data-toggle="modal" data-target="#rejectModal" data-wid = "<?php echo $data['id']; ?>">Disable</a>
                                                                    <?php }?>
																</td>
