...
$db = getDB();
$response = AdminHelper::getDailyUserWithdrawalHistory($db);
?>  
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <div class="d-inline">
                            <h4>User withdrawal table</h4>
                            <span>Summary of all withdrawal of users</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item"><a href="#!">User withdrawal info</a> </li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <div class="row align-items-center">
                                <div class="mr-4">
                                <select class="btn btn-primary my-2" id="withdrawal-day-select">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($response as $data) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data["transaction_hash"]; ?></td>
...
function getData() {
        ...
        $.ajax({
            url: "ajax/ajax_user_withdrawal_history.php", // Replace with your PHP file that fetches filtered data
            method: "GET",
...
$(document).ready(function() {
    ...
    $("#withdrawal-day-select").change(function(event) {
