...
ob_start();
    ...
    if (empty($user_name) || empty($pkg_price) || empty($pkg_type) ){
        ...
        header("Location: roi-package.php");
        exit();
    }
    ...
    $activityMessage= 'Leader ROI Package Activated '.$uname2.' And Amount is '.$pkg_price;
                        ...
                        <div class="main-body">
                            <div class="page-wrapper">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    <h4>Leader ROI Package</h4>
                                                    <span>Activate Without Bonuses and with ROI.</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Leader ROI Package</a> </li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="page-body">
                                    ...
                                    <div class="col-md-12">
                                    <h3 class="text-center">Leader ROI Package</h3>
