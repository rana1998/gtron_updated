                                        ...
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    ...
                                                    <span>Summary of all Rejected withdrawals</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Rejected Withdrawals</a> </li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
...
<!--                                    <div class="card-header table-card-header">
 ...
 -->                                        <div class="card-block">
                            ...
                            <table id="basic-btn" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                <?php 
                                    $select= "SELECT * FROM `withdrawal` WHERE status = 'Rejected'";
