...
?>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                <div class="d-inline">
                                                    ...
                                                    <span>List of  all Pending Payment</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table data-page-length="500" id="basic-btn" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                        <?php 
                        $sql = "SELECT * FROM  pending_invoice_payments";
                        ...
                        while ( $data = mysqli_fetch_array($result)):
                            ...
                            $sql2       = "SELECT * FROM  invoices WHERE invoice_id = '$invoice_id'";
                            $result2    = mysqli_query($con, $sql2);
                            $data2      = mysqli_fetch_array($result2);
                            $user_name   = $data2['user_name'];
                            $price_in_usd  = $data2['price_in_usd'];
                            $price_in_btc  = $data2['price_in_btc'];
