...
$db = getDB();
$response = AdminHelper::getDailyAdminWalletSummaryLogs($db);
?>  
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <div class="d-inline">
                            <h4>Admin wallet summary logs info</h4>
                            <span>Summary of all admin wallet summary logs</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Admin wallet summary logs</a> </li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($response as $data) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data["owner_id_fk"]; ?></td>
                                                <td><?php echo $data["wallet_address"]; ?></td>
                                                <td><?php echo $data["previous_amount"]; ?></td>
                                                <td><?php echo $data["new_amount"]; ?></td>
...
$(document).ready(function() {
    ...
    $("#day-select").change(function(event) {
        ...
        $.ajax({
            url: "ajax/ajax_admin_wallet_summary_logs.php", // Replace with your PHP file that fetches filtered data
            method: "GET",
