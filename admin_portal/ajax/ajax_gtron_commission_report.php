...
{
    $response = AdminHelper::getWeeklyAdminGtronWalletHistory($db);
} else if(isset($filter) && $filter =='monthly') {
    $response = AdminHelper::getMonthlyAdminGtronWalletHistory($db);
} else if(isset($filter) && $filter =='day-internal') {
    $start_date = $_GET['start_date'];
    $end_date = $_GET['end_date'];
    $response = AdminHelper::getIntervalAdminGtronWalletHistory($db, $start_date, $end_date);
}
else {
    $response = AdminHelper::getDailyAdminGtronWalletHistory($db);
}
