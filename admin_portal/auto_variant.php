...
if(isset($_POST['submit']))
{
    ...
    $variantName = mysqli_real_escape_string($con,$_POST['variantName']);
    $price = mysqli_real_escape_string($con,$_POST['price']);
    
    // echo $companyName.$modelName;

    $q="select * from `auto_variant` where `company`='$companyName' and model='$modelName' and variant='$variantName'";
    $result=mysqli_query($con,$q);
    $resultRow= mysqli_num_rows($result);
    
    if(empty($companyName) || empty($modelName) || empty($variantName) || empty($price))
    {
        $_SESSION['errorMsg'] = ' Please fill all data';
        header('location:auto_variant.php');
        exit();
    }
    elseif($resultRow > 0)
    {
        $_SESSION['errorMsg'] = ' Data already exist in record ';
        header('location:auto_variant.php');
        exit();
    }
    else
    {
        $qy="INSERT INTO `auto_variant`( `company`,`model`,`variant`,`price`) VALUES ('$companyName','$modelName','$variantName','$price')";
			...
			<div class="row align-items-end">
				<div class="col-lg-8">
					<div class="page-header-title">
						<div class="d-inline">
							<h4>Auto Variant Model</h4>
							<span>Add variant model below. </span>
						</div>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="page-header-breadcrumb">
						<ul class="breadcrumb-title">
							...
							<li class="breadcrumb-item"><a href="#!">Auto Variant Model</a> </li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="auth-box card">
							<div class="card-block">
								<div class="row m-b-20">
									<div class="col-md-12">
										<h3 class="text-center ">Add Variant Model</h3>
							...
							<div class="card-body">
								<form  class="md-float-material form-material" method="POST">
									...
									<div class="form-group row">
									    ...
									    ?>
											<select id="changeCompany" class="form-control" name="companyName">
										...
										<div class="col-sm-9">
											<select id="printModel" class="form-control" name="modelName">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="variantName" id="roi_percentage">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-3 col-form-label">Price</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="price" id="roi_percentage">
										</div>
									</div>
									<div class="form-group row">
										<div class="col-md-12">
