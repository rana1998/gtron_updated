...
$db = getDB();
$response = AdminHelper::getDailyUserDividendReport($db);
?>  
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        <div class="d-inline">
                            <h4>User dividend report</h4>
                            <span>Summary of all User dividend report</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item"><a href="#!">User dividend report</a> </li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script>
    function getData() {
        ...
        $.ajax({
            url: "ajax/ajax_user_dividend_report.php", // Replace with your PHP file that fetches filtered data
            method: "GET",
