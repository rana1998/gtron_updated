	...
	if(isset($_POST['update_roi'])){
		...
		$run_insert = mysqli_query($con, $insert);
			if(!$run_update && !$run_insert){
				...
				$_SESSION['successMsg']='Deposit Tax Update Successfully.';
				header("Location: deposit-tax.php");
				exit();
	}
?>
<!-- Main-body start -->
				...
				<div class="col-lg-4">
					<div class="page-header-breadcrumb">
						<ul class="breadcrumb-title">
							...
							<li class="breadcrumb-item"><a href="#!">Deposit Tax</a> </li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="auth-box card">
							<div class="card-block">
								<div class="row m-b-20">
									<div class="col-md-12">
										<h3 class="text-center ">Deposit Tax</h3>
